...
export default class ChatService extends Component {
    ...
    async getMessageFromDB() {
        ...
        try {
            const response = await axios.get(`http://192.168.1.11:8084/messages/${this.state.data.senderId}/${this.state.data.recipientId}`, {headers});
    ...
    connect(){
        let props = this;
        const socket = new SockJS('http://192.168.1.11:8084/ws');
